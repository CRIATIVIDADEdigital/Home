...
{% endcapture %}
<div class="notice--success">{{ luana | markdownify }}</div>
 ...
 * Após a conversa com os alunos, é hora de uma "encenação". Você deve falar algo como:
 {% capture papeis %} 
 &#8212; Mas o que é isso que estou ouvindo? Vocês também estão ouvindo?<br>
 Você vai até onde ficaram "escondidas" as folhas de papel A4.<br>
 &#8212; Olhem só, isso! Temos vários papéis tristinhos aqui!<br> 
 &#8212; Mas, vejam, também temo lápis coloridos!<br>
 &#8212; Que tal deixarmos esses papéis felizes, hein?!
{% endcapture %}
<div class="notice--success">{{ papeis | markdownify }}</div>
...
{% endcapture %}
<div class="notice--success">{{ computador | markdownify }}</div>
 ...
 * O processo de personalização do livro O NOME DA GENTE se encontra no endereço A personalização do livro O NOME DA GENTE O livro digital se encontra no endereço [livros.aprender.digital](https://livros.aprender.digital){:target="_blank"}.
 * Na página inicial do gerador de livros primeiro deve ser preenchido o nome da criança. Depois da digitação do nome deverá ser escolhido o gênero. A opção o **nome dele** gerará a história para o gênero masculino e opção o **nome dela** para o gênero feminino. Veja a ilustração abaixo: ![Formulário livro O Nome da Tente](/assets/roteiros/0003/home_ondg.jpg)
 * Depois de escrever o nome e escolher o gênro, pressione o botão verde para **gerar o livro**. 
